...
// lookupTable is used by ImageByName (for now).
var lookupTable = map[string]string{
	"runtimes/php":          "gcr.io/gvisor-presubmit",
	"basic/alpine":          "alpine",
	"basic/httpd":           "httpd",
	"basic/mysql":           "mysql",
	"basic/nginx":           "nginx",
...
// UniqueID returns 20 unique bytes following the given prefix.
...
func UniqueContainerID() string {
	return UniqueID("test-container-")
}
